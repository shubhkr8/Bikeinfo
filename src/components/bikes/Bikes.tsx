...
import Image from "../../images/default_bike.jpg";
import "./Bikes.css";
...
const Bikes: FC<Props> = ({ title, location, stolenDate, thumb, id }) => {
  ...
  return (
    <div className="bike_container">
      ...
      <div className="bike_details">
        <p className="bikes_title" onClick={getBikeData}>
          {title}
        </p>
        <p>Location : {location ? location : "Not Available"}</p>
        <p>Stolen Date : {displaysdate}</p>
      </div>
